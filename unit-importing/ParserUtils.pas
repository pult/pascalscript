...
const
  version = 'v0.7 (fork ver: 2018.0307)';
...
procedure RaiseError(const errormsg: string; row, col: integer);
begin
  raise {+}EParserError{+.}.create(errormsg + ' At postion: ' + inttostr(row) + ':' + inttostr(col));
end; {RaiseError}
...
begin
  result :=
    '{' + NewLine +
    {+}
    'This file has been generated by UnitParser "' + version + '".' + Newline +
    'Written by M. Knight and updated by NP. v/d Spek and George Birbilis.' + Newline +{+.}
